...
class _MyHomePageState extends State<MyHomePage> {
  String text = "";
  String finalText ="";
  void _onChanged(String _text) => setState(() => text = _text);
  void _onPressed() => setState(() => finalText = text);
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            child: TextField(onChanged: _onChanged, textAlign: TextAlign.center,
            decoration: 
            InputDecoration(
